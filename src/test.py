...
# ftp = bgc.io.get_argo('/ifremer/argo/dac/meds', wmo_nums, local_path='/Users/gordonc/Documents/data/Argo/meds')
...
woa_interp, wt, yrday = bgc.interp.interp_woa_data(xtrack, woa_track, woa_data)
z = woa_track[0]
