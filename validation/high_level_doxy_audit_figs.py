...
plt.savefig('../figures/doxy_audit/DOXY_audit_comparison_breakdown_20200725.png', bbox_inches='tight', dpi=250)
plt.close()
...
plt.savefig('../figures/doxy_audit/DOXY_audit_comparison_waffle_pct_20200725.png', bbox_inches='tight', dpi=250)
plt.close()
...
plt.savefig('../figures/doxy_audit/DOXY_audit_comparison_waffle_20200725.png', bbox_inches='tight', dpi=250)
plt.close()