...
plt.savefig('../figures/doxy_audit/DOXY_audit_comparison_waffle_pct.png', bbox_inches='tight', dpi=250)
plt.close()

waf = plt.figure(FigureClass=Waffle, rows=50, values=counts['N'].round().values, labels=list(counts.name), colors=tuple(palette), 
